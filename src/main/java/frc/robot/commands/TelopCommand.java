...
public class TelopCommand extends CommandBase {
    ...
    public TelopCommand(DriveType drivetype, int seconds, String filename, DriveSubsystem subsystem, LiftSubsystem liftsub) {
    ...
    public void execute() {
        ...
        if (m_driveType != DriveType.Playback) {
            ...
            if (m_driveType == DriveType.Record){
                ...
                buttonALOW, buttonBMID, buttonYHIGH, buttonXRESET);
