...
public class MAXSwerveModule {
  ...
  private final WPI_TalonFX m_drivingTalonFX;
 ...
 // private final PIDController m_drivingPIDController;
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    m_drivingTalonFX = new WPI_TalonFX(drivingCANId);
    ...
    //m_drivingTalonFX.configFactoryDefault();  //don't do this
    m_turningSparkMax.restoreFactoryDefaults();

    // Setup encoders and PID controllers for the driving and turning SPARKS MAX.
    //m_drivingEncoder = m_drivingTalonFX.getEncoder;
    m_turningEncoder = m_turningSparkMax.getAbsoluteEncoder(Type.kDutyCycle);
    
    //m_drivingPIDController = m_drivingTalonFX.getPIDConfigs();
