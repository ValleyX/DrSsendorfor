...
//i.first.wpilibj.ADIS16470_IMU;
import frc.robot.Constants.DriveConstants;
import frc.utils.SwerveUtils;
import edu.wpi.first.wpilibj2.command.SubsystemBase;// 5 falconsrx 4 neo500 6 falconsfx
...
public class DriveSubsystem extends SubsystemBase {
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      //Rotation2d.fromDegrees(m_gyro.getAbsoluteCompassHeading()),
  ...
  public void periodic() {
    ...
    m_odometry.update(
        ...
        SmartDashboard.putNumber("BackLeft ", m_rearLeft.getPosition()) ;   
        SmartDashboard.putNumber("BackRight ", m_rearRight.getPosition()) ;   
*/
      }
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    SmartDashboard.putNumber("Pigeon readings", getHeading());
